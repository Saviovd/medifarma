  ...
  return (
    <div className="min-h-screen w-full font-[family-name:var(--font-geist-sans)] p-4 md:p-8 pt-40 relative overflow-hidden">
      ...
      <main className="flex flex-col gap-10 md:gap-0 row-start-2 items-start justify-start sm:items-start mt-5 pb-20 lg:pb-48">
        <div className="bg-[url('/images/PATTERN02.svg')] bg-no-repeat bg-bottom bg-cover w-screen h-[490px] absolute top-0 left-0 -z-[1]"></div>
        <Painel />
        <About />
        <CardList />
        <Location />
        <Contact />
        <div className="bg-[url('/images/PATTERN02.svg')] bg-no-repeat bg-top bg-cover w-screen h-[125px] sm:h-[150px] lg:h-[270px] absolute bottom-0 left-0 -z-[1]"></div>
      </main>
